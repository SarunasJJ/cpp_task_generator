...
class Compiler:
    ...
    @staticmethod
    def compile_and_test(cpp_code, test_cases):
        results = {
            'compiled': False,
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            compile_success = Compiler._compile(cpp_file, exe_file, results)
    ...
    @staticmethod
    def _compile(cpp_file, exe_file, results):
        try:
            ...
            if compile_result.returncode != 0:
                results['compilation_error'] = compile_result.stderr
                return False
